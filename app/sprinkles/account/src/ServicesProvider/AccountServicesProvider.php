...
class AccountServicesProvider
{
    ...
    public function register($container)
    {
        ...
        $container['currentUser'] = function ($c) {
            ...
            //Debug::debug("Loader " . print_r($c->view->getLoader(), true));

            if ($currentUser->theme != "") {
                $templatePaths = $c->locator->findResources('templates://'.$currentUser->theme, true, false);
                foreach ($templatePaths as $path) {
                    Debug::debug("Adding Paht " . $path);
                    $c->view->getLoader()->prependPath($path);
                }
                //Debug::debug("Loader " . print_r($c->view->getLoader(), true));
            }
